...
/**
 * Created by Reuel Lucas on 12/12/2016.
 */
...
////                int status;
////                status = pedido.getStatus_do_pedido() + 1;
////                pedido.setStatus_do_pedido(status);
//
//                pedido.setStatus_do_pedido(pedido.getStatus_do_pedido()+1);
//
////                String chave;
////                chave = pedido.getChave();
////                dataBase.child(chave).child("status_do_pedido").setValue(pedido.getStatus_do_pedido());
//
                dataBase.child(pedido.getChave()).child("status_do_pedido").setValue(pedido.getStatus_do_pedido()+1);
